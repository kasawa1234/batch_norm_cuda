...
optimizer_conv_parallel = optim.Adam(model_conv_parallel.parameters(), lr=0)
...
train(model_conv_parallel_sram, train_loader=train_loader, optimizer = optimizer_conv_parallel_sram, criterion = criterion, epochs=epochs)
torch.cuda.synchronize(device="cuda:0")
